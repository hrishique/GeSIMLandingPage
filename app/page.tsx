                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full h-full flex items-center justify-center scale-90 sm:scale-100 md:scale-110 origin-center">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-[110%] sm:-translate-x-[120%] md:-translate-x-[130%] transform hover:scale-105 transition-all duration-500 z-10 group cursor-pointer">
                      <div
                        className={`w-32 sm:w-40 md:w-48 rounded-[2.2rem] md:rounded-[3rem] overflow-hidden shadow-[0_35px_60px_-15px_rgba(0,0,0,0.5)] ${isDark ? "bg-slate-900" : "bg-white"}`}
                      >
                        <Image
                    ...
                    <div className="relative z-20 transform hover:scale-110 transition-all duration-500 group cursor-pointer">
                      <div
                        className={`w-40 sm:w-48 md:w-56 rounded-[2.2rem] md:rounded-[3rem] overflow-hidden shadow-[0_35px_60px_-15px_rgba(0,0,0,0.5)] ${isDark ? "bg-slate-900" : "bg-white"
                          }`}
                      >
                        <Image
                          src="/images/screenshot-20251227-125437.png"
