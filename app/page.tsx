        ...
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[24rem] lg:w-96 aspect-square">
                {/* Central Intersection Hub */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative">
                    {/* Core Hub */}
                    <div
                      className={`w-16 h-16 sm:w-24 sm:h-24 ${isDark ? "bg-gradient-to-br from-slate-700 to-slate-800" : "bg-gradient-to-br from-slate-800 to-slate-900"} rounded-full shadow-2xl flex items-center justify-center border-4 ${isDark ? "border-slate-600" : "border-white"} overflow-hidden`}
                    >
                    ...
                    {/* Pulsing Rings */}
                    <div
                      className={`absolute inset-0 w-16 h-16 sm:w-24 sm:h-24 border-2 ${isDark ? "border-slate-600/40" : "border-slate-400/40"} rounded-full animate-ping`}
                    ></div>
                    <div
                      className={`absolute -inset-2 w-20 h-20 sm:w-28 sm:h-28 border-2 ${isDark ? "border-slate-600/30" : "border-slate-400/30"} rounded-full animate-ping`}
                ...
                <div className="absolute inset-0 animate-spin-slow">
                  <div className="relative w-full h-full">
                    {/* Telecom Node 1 */}
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-4 sm:-translate-y-6">
                      <div
                        className={`w-12 h-12 sm:w-16 sm:h-16 ${isDark ? "bg-blue-600" : "bg-blue-700"} rounded-2xl p-2 sm:p-3 shadow-xl border-2 ${isDark ? "border-blue-500" : "border-blue-600"}`}
                      >
                    ...
                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-4 sm:translate-y-6">
                      <div
                        className={`w-12 h-12 sm:w-16 sm:h-16 ${isDark ? "bg-green-600" : "bg-green-700"} rounded-2xl p-2 sm:p-3 shadow-xl border-2 ${isDark ? "border-green-500" : "border-green-600"}`}
                      >
                ...
                <div className="absolute inset-0 animate-spin-reverse">
                  <div className="relative w-full h-full">
                    {/* Web3 Node 1 */}
                    <div className="absolute left-0 top-1/2 transform -translate-x-4 sm:-translate-x-6 -translate-y-1/2">
                      <div
                        className={`w-10 h-10 sm:w-14 sm:h-14 ${isDark ? "bg-purple-600" : "bg-purple-700"} rounded-xl p-2 sm:p-2.5 shadow-xl border-2 ${isDark ? "border-purple-500" : "border-purple-600"}`}
                      >
                    ...
                    {/* Web3 Node 2 */}
                    <div className="absolute right-0 top-1/2 transform translate-x-4 sm:translate-x-6 -translate-y-1/2">
                      <div
                        className={`w-10 h-10 sm:w-14 sm:h-14 ${isDark ? "bg-cyan-600" : "bg-cyan-700"} rounded-xl p-2 sm:p-2.5 shadow-xl border-2 ${isDark ? "border-cyan-500" : "border-cyan-600"}`}
                      >
                ...
                <div className="absolute inset-0">
                  {/* Telecom Orbit Ring */}
                  <div
                    className={`absolute inset-6 sm:inset-8 border-2 border-dashed ${isDark ? "border-blue-500/30" : "border-blue-600/30"} rounded-full`}
                  ></div>

                  {/* Web3 Orbit Ring */}
                  <div
                    className={`absolute inset-10 sm:inset-12 border-2 border-dashed ${isDark ? "border-purple-500/30" : "border-purple-600/30"} rounded-full`}
                  ></div>
                </div>

                {/* Floating Network Nodes */}
                <div className="absolute top-12 sm:top-16 right-12 sm:right-16 animate-bounce">
                  <div
                    className={`w-6 h-6 sm:w-8 sm:h-8 ${isDark ? "bg-orange-600" : "bg-orange-700"} rounded-full flex items-center justify-center shadow-lg`}
                  >
                    <Network className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                  </div>
                </div>

                <div className="absolute bottom-12 sm:bottom-16 left-12 sm:left-16 animate-bounce" style={{ animationDelay: "1s" }}>
                  <div
                    className={`w-5 h-5 sm:w-6 sm:h-6 ${isDark ? "bg-pink-600" : "bg-pink-700"} rounded-full flex items-center justify-center shadow-lg`}
                  >
      ...
      <section id="features" className={`py-32 px-6 ${isDark ? "bg-slate-950" : "bg-white"}`}>
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-20">
            <div className="flex items-center justify-center md:gap-3 mb-6">
              <Zap className={`w-10 h-10 ${isDark ? "text-slate-400" : "text-slate-600"}`} />
              <h2 className={`text-3xl md:text-4xl font-bold ${isDark ? "text-white" : "text-slate-900"}`}>
